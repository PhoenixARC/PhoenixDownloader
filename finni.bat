...
md backups\%currentdate%\PODCAST%podno%\USRDIR\images
copy path\%podno%\dev_hdd0\game\PODCAST%podno%\USRDIR backups\%currentdate%\PODCAST%podno%\USRDIR
copy path\%podno%\dev_hdd0\game\PODCAST%podno%\USRDIR\images backups\%currentdate%\PODCAST%podno%\USRDIR\images
pause
(
echo ^<Items^>
